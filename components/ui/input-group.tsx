...
function InputGroupAddon({
  ...
  return (
    // Mouse/touch-only convenience: clicking the icon area focuses the
    // sibling input. Keyboard users already reach that input directly via
    // Tab, so no keyboard equivalent is needed here.
